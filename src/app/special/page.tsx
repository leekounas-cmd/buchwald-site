...
const includedItems = [
  ...
  { title: "Insurance Verified Before You Come In", desc: "We verify your benefits and tell you exactly what (if anything) you owe before your visit. No surprise bills." },
];
