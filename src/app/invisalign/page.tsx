...
const faqs = [
  ...
  { q: "Is Invisalign covered by insurance?", a: "Many dental insurance plans cover Invisalign the same way they cover braces. We'll check your benefits and let you know exactly what's covered." },
      ...
      <section className="py-10 sm:py-20 bg-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.1 }} className="mb-10">
            <Image src="/images/stock/invisalign.jpg" alt="Invisalign clear aligners at Buchwald Family Dentistry in Richardson, TX" width={1200} height={600} className="rounded-2xl w-full object-cover aspect-video" priority />
          </motion.div>
