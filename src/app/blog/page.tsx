      ...
      <section className="py-10 sm:py-16 bg-white">
        <div className="mx-auto max-w-5xl px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center mb-8">
            <p className="text-primary-dark text-xs font-bold uppercase tracking-[0.22em] mb-3">Dental Blog</p>
            <h1 className="font-archivo text-4xl sm:text-5xl text-gray-900 leading-[1.1]">Quick Reads for a Healthier Smile</h1>
          </motion.div>
