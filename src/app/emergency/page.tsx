    ...
    <>
      ...
      <section className="py-10 sm:py-16 bg-white">
        <div className="mx-auto max-w-6xl px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center">
            <p className="text-primary-dark text-xs font-bold uppercase tracking-[0.22em] mb-3">Emergency Care</p>
            <h1 className="font-archivo text-4xl sm:text-5xl text-gray-900 leading-[1.1] mb-8">Dental Emergency? Call Now.</h1>
          </motion.div>
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <h2 className="font-archivo text-2xl sm:text-3xl text-gray-900 mt-10 mb-2">What Counts as a Dental Emergency?</h2>
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="font-archivo text-2xl sm:text-3xl text-gray-900 mb-2">What to Do Before You Get Here</h2>
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="font-archivo text-2xl sm:text-3xl text-gray-900 mb-4">Why Choose Us for Emergency Care</h2>
          <Checklist items={[
