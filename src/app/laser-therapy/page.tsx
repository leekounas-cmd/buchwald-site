...
const faqs = [
  ...
  { q: "Does insurance cover laser therapy?", a: "Coverage varies by plan and procedure. Some laser treatments are covered under periodontal care. Lee will check your specific benefits before any treatment." },
      ...
      <section className="py-10 sm:py-16 bg-white">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.1 }} className="mb-10">
            <Image src="/images/stock/laser.jpg" alt="Advanced laser dental therapy at Buchwald Family Dentistry in Richardson, TX" width={1200} height={600} className="rounded-2xl w-full object-cover aspect-video" priority />
          </motion.div>
