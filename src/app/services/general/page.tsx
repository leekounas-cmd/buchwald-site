...
const concerns = [
  ...
  { title: "\"How much will it cost?\"", desc: "We're upfront about pricing before treatment. We'll verify your insurance and walk you through options." },
...
const faqs = [
  ...
  { q: "Do you offer payment plans?", a: "Yes. We offer flexible payment options so cost doesn't stand in the way of the care you need. Ask our team about your options." },
