...
const faqs = [
  ...
  { q: "Is cosmetic dentistry covered by insurance?", a: "Most cosmetic procedures aren't covered, but some (like bonding for a chipped tooth) may be partially covered. We'll check your benefits and explain your options." },
