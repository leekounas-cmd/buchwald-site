...
export const blogPosts: BlogPost[] = [
  {
    title: "What Is a Deep Cleaning (And Why Your Dentist Might Recommend One)",
    slug: "what-is-a-deep-cleaning",
    date: "2026-04-18",
    readTime: "3 min read",
    excerpt:
      "If it has been a while since your last dental visit, a deep cleaning might be the first step back. Here's what it is, why it matters, and why getting one now saves you from bigger problems later.",
    faqs: [
      { q: "What is a deep cleaning?", a: "A deep cleaning (also called scaling and root planing, or SRP) removes plaque and tartar from below the gumline and smooths the tooth roots so gums can reattach. It treats early gum disease (gingivitis and periodontitis) before bone loss sets in." },
      ...
      { q: "Does a deep cleaning hurt?", a: "Most patients feel minimal discomfort. We use local anesthetic if needed and our hygienist Melisa is known for being genuinely gentle. After more than 2,000 cleanings in our chair, patients consistently say it was more comfortable than they expected." },
